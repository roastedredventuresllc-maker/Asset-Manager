...
const NOT_IMPLEMENTED =
  "Live publishing to Google Ads is not yet implemented. Keep ADS_MODE=mock, " +
  "or publish via Meta/TikTok. Connect Google Ads in the admin Connectors section to prepare credentials.";

/**
 * Live Google Ads platform. The factory recognizes Google Ads so it can be
