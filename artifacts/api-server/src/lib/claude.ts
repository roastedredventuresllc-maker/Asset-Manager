...
- Three ads remain ONE campaign: same product, same SKU, same clay color, same light family, same color temperature. Beats: hero, context, tight crop — not three random boards. Tight crop keeps the hero silhouette (handle stays if the hero has a handle) and crops through the body, not a second full pack-shot.
